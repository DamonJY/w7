 ...
 * 
 */
$_W['page']['title'] = ' Angel Cms 云服务诊断 -  Angel Cms 云服务';
...
if ($do == 'testapi') {
	...
	$response = cloud_request('http://admin.zheyitianshi.com', array(), array('ip' => $_GPC['ip']));
	...
	if (checksubmit('updateserverip')) {
		...
		message('修改 Angel Cms 云服务ip成功.', 'refresh');
	}
