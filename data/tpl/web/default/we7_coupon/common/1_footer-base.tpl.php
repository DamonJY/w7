	...
	<div class="container-fluid footer text-center" role="footer">	
		<div class="friend-link">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
				<a href="http://www.zheyitianshi.com">微信开发</a>&nbsp;&nbsp;
		...
		<div><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.zheyitianshi.com"><b>微擎</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.zheyitianshi.com">www.zheyitianshi.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
	</div>
