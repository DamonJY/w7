<?php defined('IN_IA') or exit('Access Denied');?>			</div>
		...
		<div class="center-block footer" role="footer">
			...
			<div class="text-center">
				<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.zheyitianshi.com"><b>微擎</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.zheyitianshi.com">www.zheyitianshi.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
			</div>
		</div>
	</div>
