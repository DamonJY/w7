...
<div class="home">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($copyright['footerright'])) { ?><a href="http://www.zheyitianshi.com">关于微擎</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">微擎论坛</a>&nbsp;&nbsp;<a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAwMzEzOV8xNzEwOTZfNDAwMDgyODUwMl8yXw">联系客服</a><?php  } else { ?><?php  echo $copyright['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($copyright['statcode'])) { ?><?php  echo $copyright['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($copyright['footerleft'])) { ?>Powered by <a href="http://www.zheyitianshi.com"><b>微擎</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.zheyitianshi.com">www.zheyitianshi.com</a><?php  } else { ?><?php  echo $copyright['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
