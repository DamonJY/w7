			...
			<tr ng-repeat="module in module_list">
				...
				<td class="text-left">
					<div class="link-group">
						...
						<a href="<?php  echo url('system/module/uninstall', array('account_type' => 4))?>&name={{ module.name }}" ng-if="isFounder == 1" class="del">停用</a>
						...
						<a href="javascript:;" class="del" ng-click="setUpgradeInfo(module.name)" ng-if="module.upgrade && module.from == 'cloud' && isFounder == 1">升级</a>
					</div>
				</td>
			</tr>
		</table>
