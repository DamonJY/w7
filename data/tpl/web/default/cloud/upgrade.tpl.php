...
<div class="upgrade-content">
	<div class="upgrade-heading we7-padding-vertical text-center">
		...
		<h2 class="upgrade-version">系统当前版本: Angel Cms（<?php echo IMS_RELEASE_DATE;?>）</h2>
	</div>
	...
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			...
			<script type="text/javascript" src="http://www.zheyitianshi.com/api.php?mod=js&bid=22"></script>
			</ul>
		</div>
	</div>
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			<ul class="list-unstyled">
			<script type="text/javascript" src="http://www.zheyitianshi.com/api.php?mod=js&bid=21"></script>
			</ul>
		</div>
	</div>
</div>
